...
* [MCP Context Forge](https://github.com/IBM/mcp-context-forge) ⭐ 4,340 | 🐛 1,292 | 🌐 Python | 📅 2026-08-19 - Model Context Protocol gateway & proxy - unify REST, MCP, and A2A with federation, virtual servers, retries, security, and an optional admin UI.
...
* [Unla](https://github.com/AmoyLab/Unla) ⭐ 2,206 | 🐛 93 | 🌐 TypeScript | 📅 2026-08-04 - MCP Gateway - A lightweight gateway service that instantly transforms existing MCP Servers and APIs into MCP servers with zero code changes.
* [Docker MCP Gateway](https://github.com/docker/mcp-gateway) ⭐ 1,535 | 🐛 122 | 🌐 Go | 📅 2026-08-18 - Docker MCP CLI plugin / MCP Gateway.
* [Obot](https://github.com/obot-platform/obot) ⭐ 949 | 🐛 395 | 🌐 Go | 📅 2026-08-18 - Open-source MCP Gateway and AI Platform.
* [MCP Gateway & Registry](https://github.com/agentic-community/mcp-gateway-registry) ⭐ 867 | 🐛 122 | 🌐 Python | 📅 2026-08-19 - Enterprise-ready MCP Gateway & Registry that centralizes AI development tools with secure OAuth authentication, dynamic tool discovery, and unified access for both autonomous AI agents and AI coding assistants. Transform scattered MCP server chaos into governed, auditable tool access with Keycloak/Entra integration.
...
* [MCP Mesh](https://github.com/decocms/mesh) ⭐ 399 | 🐛 237 | 🌐 TypeScript | 📅 2026-08-19 - Open-source MCP control plane that routes all MCP traffic through one governed endpoint. Features RBAC (OAuth 2.1 + API keys), encrypted token vault, runtime strategies as gateways for smart tool selection, Virtual MCPs for composing toolsets, and full OpenTelemetry observability. Multi-tenant with org scoping.
...
* [mcpproxy-go](https://github.com/smart-mcp-proxy/mcpproxy-go) ⭐ 319 | 🐛 13 | 🌐 Go | 📅 2026-08-19 - Open-source local MCP proxy server. Routes multiple MCP servers through a single endpoint with BM25 tool filtering, activity logging, quarantine security, and web UI.
...
* [AIRIS MCP Gateway](https://github.com/agiletec-inc/airis-mcp-gateway) ⭐ 170 | 🐛 11 | 🌐 Python | 📅 2026-08-12 - Docker-based MCP multiplexer that aggregates 60+ tools behind 7 meta-tools (find, exec, schema, suggest, route, confidence, repo-index). Reduces context tokens by 97% via progressive disclosure with auto-enable on demand, HOT/COLD server lifecycle, and circuit breaker.
