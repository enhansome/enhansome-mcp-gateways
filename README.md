...
* [agentgateway](https://github.com/agentgateway/agentgateway) ⭐ 4,634 | 🐛 260 | 🌐 Rust | 📅 2026-08-27 - Next Generation Agentic Proxy for AI Agents and MCP servers that provides drop-in security, observability, and governance for agent-to-agent and agent-to-tool communication.
* [MCP Context Forge](https://github.com/IBM/mcp-context-forge) ⭐ 4,386 | 🐛 1,165 | 🌐 Python | 📅 2026-08-28 - Model Context Protocol gateway & proxy - unify REST, MCP, and A2A with federation, virtual servers, retries, security, and an optional admin UI.
* [MetaMCP](https://github.com/metatool-ai/metamcp) ⭐ 2,634 | 🐛 105 | 🌐 TypeScript | 📅 2026-06-22 - MCP Aggregator, Orchestrator, Middleware, Gateway.
...
* [Docker MCP Gateway](https://github.com/docker/mcp-gateway) ⭐ 1,544 | 🐛 130 | 🌐 Go | 📅 2026-08-26 - Docker MCP CLI plugin / MCP Gateway.
* [Obot](https://github.com/obot-platform/obot) ⭐ 965 | 🐛 374 | 🌐 Go | 📅 2026-08-29 - Open-source MCP Gateway and AI Platform.
...
* [MCP Mesh](https://github.com/decocms/mesh) ⭐ 402 | 🐛 231 | 🌐 TypeScript | 📅 2026-08-29 - Open-source MCP control plane that routes all MCP traffic through one governed endpoint. Features RBAC (OAuth 2.1 + API keys), encrypted token vault, runtime strategies as gateways for smart tool selection, Virtual MCPs for composing toolsets, and full OpenTelemetry observability. Multi-tenant with org scoping.
...
* [mcpproxy-go](https://github.com/smart-mcp-proxy/mcpproxy-go) ⭐ 326 | 🐛 15 | 🌐 Go | 📅 2026-08-29 - Open-source local MCP proxy server. Routes multiple MCP servers through a single endpoint with BM25 tool filtering, activity logging, quarantine security, and web UI.
...
* [ToolSDK MCP Registry](https://github.com/toolsdk-ai/toolsdk-mcp-registry) ⭐ 186 | 🐛 26 | 🌐 TypeScript | 📅 2026-08-27 - Enterprise MCP Gateway with federated search, secure sandbox execution, OAuth 2.1 proxy, and unified HTTP API. Self-hosted via Docker.
